        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-slate-400 leading-relaxed mb-4">
              Your trusted partner for online education. We help students get admission in top universities with UGC-approved online degree programs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/courses" className="text-slate-400 hover:text-white transition-colors duration-200">
                  Courses
                </Link>
              </li>
              <li>
                <Link href="/universities" className="text-slate-400 hover:text-white transition-colors duration-200">
                  Universities
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+917275131439" className="text-slate-400 hover:text-white transition-colors duration-200">
                  +91 7275131439
                </a>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-400">Noida, Uttar Pradesh, India</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-6 justify-center md:justify-end">
              ...
              <Link href="/refund" className="text-sm text-slate-400 hover:text-white transition-colors duration-200">
                Refund Policy
              </Link>
            </div>
          </div>
